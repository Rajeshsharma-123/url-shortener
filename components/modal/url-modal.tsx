...
const formSchema = z.object({
  // ✅ Keep original case for URLs
  url: z.string().url({ message: 'Please enter a valid URL.' }),
  
  // ✅ Keep keyword lowercase
  keyword: z
    .string()
    .toLowerCase()
...
const UrlModal = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      // ✅ Get page title safely through your own API
      ...
      const title = encodeURI(data.title ?? values.url);
      ...
      console.error('[URL_MODAL_ERROR]', error);
